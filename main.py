...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold white][01] Change money ~ 1K[/bold cyan]")
            console.print("[bold white][02] Change coin ~ 3.5K[/bold cyan]")
            console.print("[bold white][03] Instan king 156 achievement ~ 4K[/bold cyan]")
            console.print("[bold white][04] Custon ID ~ 3.5K[/bold cyan]")
            console.print("[bold white][05] Custon name ~ 100[/bold cyan]")
            console.print("[bold white][06] Custon rainbow name ~ 100[/bold cyan]")
            console.print("[bold white][07] Number plates ~ 2K[/bold cyan]")
            console.print("[bold white][08] Delete account ~ FREE[/bold cyan]")
            console.print("[bold white][09] Register account ~ FREE[/bold cyan]")
            console.print("[bold white][10] Delete friend list ~ 500[/bold cyan]")
            console.print("[bold white][11] Unlock premiun cars ~ 4K[/bold cyan]")
            console.print("[bold white][12] Unlock all cars ~ 3K[/bold cyan]")
            console.print("[bold white][13] Unlock siren cars ~ 2K[/bold cyan]")
            console.print("[bold white][14] Unlock w16 engine ~ 3K[/bold cyan]")
            console.print("[bold white][15] Unlock all horns ~ 3K[/bold cyan]")
            console.print("[bold white][16] Unlock disable damage ~ 2K[/bold cyan]")
            console.print("[bold white][17] Unlock unlimited fuel ~ 2K[/bold cyan]")
            console.print("[bold white][18] Unlock house premiun ~ 3.5K[/bold cyan]")
            console.print("[bold white][19] Unlock smoke ~ 2K[/bold cyan]")
            console.print("[bold white][20] Change race win ~ 1K[/bold cyan]")
            console.print("[bold white][21] Change race lose ~ 1K[/bold cyan]")
            console.print("[bold white][22] Copy car to other account ~ 5K[/bold cyan]")
            console.print("[bold white][00] Exit tools[/bold cyan]", end="\n\n")
